...
module.exports = "<toaster-container [toasterconfig]=\"toasterconfig\"></toaster-container>\r\n<ng4-loading-spinner></ng4-loading-spinner>\r\n<div class=\"container-fluid\">\r\n  <div class=\"row clearfix\">\r\n    <div class=\"col-lg-4 col-md-12\">\r\n      <div class=\"card mcard_3\">\r\n        <div class=\"card-body\">\r\n          <img [src]=\"sanitizeImageUrl(imgURL)\"  class=\"rounded-circle shadow \" width=\"130px\" height=\"130px\" alt=\"profile-image\">\r\n          <div class=\"main-file-input\">\r\n            <!-- <input type=\"file\" (change)=\"onAdd($event)\" [hidden]=\"toggleButton\" class=\"custom-file-input\"> -->\r\n            <input type=\"file\" ng2FileSelect [uploader]=\"uploader\" [hidden]=\"toggleButton\" (change)=\"onAdd($event)\"\r\n              class=\"custom-file-input\" />\r\n          </div>\r\n          <h4 class=\"m-t-10\">{{user.FIRST_NAME}} {{user.LAST_NAME}}</h4>\r\n\r\n          <div class=\"row\">\r\n            <div class=\"col-12\">\r\n              <!-- <ul class=\"social-links list-unstyled sld\">\r\n                <li><a title=\"facebook\" href=\"javascript:void(0);\"><i class=\"fa fa-facebook fa-lg\"></i></a></li>\r\n                <li><a title=\"twitter\" href=\"javascript:void(0);\"><i class=\"fa fa-twitter fa-lg\"></i></a></li>\r\n                <li><a title=\"instagram\" href=\"javascript:void(0);\"><i class=\"fa fa-instagram fa-lg\"></i></a></li>\r\n              </ul> -->\r\n              <p class=\"text-muted\">{{user.ADDRESS}}</p>\r\n            </div>\r\n            <div class=\"col-md-12\">\r\n              <small class=\"text-muted\">Email address: </small>\r\n              <p>{{user.EMAIL}}</p>\r\n            </div>\r\n            <div class=\"col-md-12\">\r\n              <small class=\"text-muted\">Phone: </small>\r\n              <p>+ {{user.PHONE}}</p>\r\n             \r\n            </div>\r\n\r\n          </div>\r\n        </div>\r\n      </div>\r\n\r\n    </div>\r\n    <div class=\"col-lg-8 col-md-12\">\r\n      <div class=\"card\">\r\n        <div class=\"card-header\">\r\n          <div class=\"row\">\r\n            <div class=\"col-md-6\">\r\n              <span class=\"name-header\"> {{user.FIRST_NAME}} {{user.LAST_NAME}}</span>\r\n            </div>\r\n            <div class=\"col-md-6 text-right\">\r\n              <button class=\"btn btn-primary\" *ngIf=\"toggleButton==true\" (click)=\"enable()\"><i\r\n                  class=\"fa fa-edit fa-lg\"></i></button>\r\n              <button class=\"btn btn-danger\" *ngIf=\"toggleButton==false\" (click)=\"disable()\"><i\r\n                  class=\"fa fa-remove fa-lg\"></i></button>\r\n              <button class=\"btn btn-success\" (click)=\"updateProfile()\" *ngIf=\"toggleButton==false\"\r\n                (click)=\"disable()\"><i class=\"fa fa-check fa-lg\"></i></button>\r\n            </div>\r\n          </div>\r\n        </div>\r\n\r\n        <div class=\"card-body\">\r\n\r\n          <div class=\"row\">\r\n            <div class=\"form-group col-sm-6\">\r\n              <label for=\"city\">First Name</label>\r\n              <input type=\"text\" class=\"form-control\" [(ngModel)]=\"user.FIRST_NAME\" name=\"FIRST_NAME\"\r\n                #FIRST_NAME=\"ngModel\" required [disabled]='toggleButton' placeholder=\"Enter First Name\">\r\n            </div>\r\n            <div class=\"form-group col-sm-6\">\r\n              <label for=\"postal-code\">Last Name</label>\r\n              <input type=\"text\" class=\"form-control\" [(ngModel)]=\"user.LAST_NAME\" name=\"LAST_NAME\" #LAST_NAME=\"ngModel\"\r\n                required [disabled]='toggleButton' placeholder=\"Enter Last Name\">\r\n            </div>\r\n          </div>\r\n          <div class=\"row\">\r\n            <div class=\"form-group col-sm-6\">\r\n              <label for=\"city\">Email</label>\r\n              <input type=\"text\" class=\"form-control\" [(ngModel)]=\"user.EMAIL\" name=\"EMAIL\" #EMAIL=\"ngModel\"\r\n                placeholder=\"Enter email\" pattern=\"^\\w+([\\.-]?\\w+)*@\\w+([\\.-]?\\w+)*(\\.\\w{2,3})+$\" required\r\n                [disabled]='toggleButton' placeholder=\"Enter Email\">\r\n            </div>\r\n            <div class=\"form-group col-sm-6\">\r\n              <label for=\"postal-code\">Phone</label>\r\n              <input type=\"text\" class=\"form-control\" [(ngModel)]=\"user.PHONE\" name=\"PHONE\" #PHONE=\"ngModel\"\r\n                (keypress)=\"keyPress($event)\" minlength=10 maxlength=10 [disabled]='toggleButton'\r\n                placeholder=\"Enter Phone\">\r\n            </div>\r\n          </div>\r\n          <div class=\"row\">\r\n            <div class=\"form-group col-sm-6\">\r\n              <label for=\"city\">Date of Birth</label>\r\n              <!-- <input type=\"text\" class=\"form-control\" [disabled]='toggleButton' placeholder=\"03/03/2020\"> -->\r\n              <input type=\"text\" class=\"form-control\" [disabled]='toggleButton' [(ngModel)]=\"user.DOB\" name=\"DOB\"\r\n                #DOB=\"ngModel\" #dp=\"bsDatepicker\" bsDatepicker>\r\n            </div>\r\n            <div class=\"form-group col-sm-6\">\r\n              <label for=\"street\">Address</label>\r\n              <!-- <input type=\"text\" class=\"form-control\" id=\"street\" placeholder=\"Enter street name\"> -->\r\n              <textarea class=\"form-control\" [(ngModel)]=\"user.ADDRESS\" name=\"ADDRESS\" #ADDRESS=\"ngModel\"\r\n                [disabled]='toggleButton' rows=\"2\" placeholder=\"Enter your address\"></textarea>\r\n            </div>\r\n          </div>\r\n          <div class=\"row\">\r\n            <div class=\"form-group col-sm-8\">\r\n              <label for=\"price\">Price</label>\r\n              <input type=\"text\" class=\"form-control\" [(ngModel)]=\"user.PRICE\" name=\"PRICE\" #PRICE=\"ngModel\"\r\n                [disabled]='toggleButton' placeholder=\"Enter your Price\">\r\n            </div>\r\n\r\n          </div>\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>\r\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ng2_file_upload__ = __webpack_require__("../../../../ng2-file-upload/fesm5/ng2-file-upload.js");
...
var ProfileComponent = /** @class */ (function () {
    function ProfileComponent(_user_service, toasterService, sanitizer, spinnerService, http) {
        this._user_service = _user_service;
        this.toasterService = toasterService;
        this.sanitizer = sanitizer;
        this.spinnerService = spinnerService;
        this.http = http;
        this.uploader = new __WEBPACK_IMPORTED_MODULE_3_ng2_file_upload__["b" /* FileUploader */]({
            isHTML5: true
        });
    ...
    ProfileComponent.prototype.sanitizeImageUrl = function (imageUrl) {
    ...
    ProfileComponent.prototype.uploadFile = function (data, item) {
        var _this = this;
        var userId = item._id;
        this.http.post(__WEBPACK_IMPORTED_MODULE_4_app_app_config__["a" /* appConfig */].apiUrl + '/user/profilePic/' + userId, data, { reportProgress: true, observe: 'events' })
            .subscribe(function (event) {
            if (event.type === __WEBPACK_IMPORTED_MODULE_5__angular_common_http__["d" /* HttpEventType */].UploadProgress) {
                console.log("success");
            }
            else if (event instanceof __WEBPACK_IMPORTED_MODULE_5__angular_common_http__["f" /* HttpResponse */]) {
                _this.setData(event.body);
            }
        });
    };
    ProfileComponent.prototype.setData = function (updatedUser) {
        this.user = updatedUser.data;
        localStorage.setItem('user', JSON.stringify(this.user));
        console.log("set Data", this.user);
    };
    ProfileComponent.prototype.uploadSubmit = function (profile) {
    ...
    ProfileComponent.prototype.enable = function () {
        this.toggleButton = false;
    };
    ProfileComponent.prototype.disable = function () {
        this.toggleButton = true;
    };
    ProfileComponent.prototype.onAdd = function (event) {
        var _this = this;
    ...
    ProfileComponent.prototype.keyPress = function (event) {
        var pattern = /[0-9\+\-\ ]/;
    ...
    ProfileComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            styles: [__webpack_require__("../../../../../src/app/views/profile/profile.component.scss"), __webpack_require__("../../../../../src/scss/vendors/bs-datepicker/bs-datepicker.scss"), __webpack_require__("../../../../../src/scss/vendors/toastr/toastr.scss")],
            encapsulation: __WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewEncapsulation"].None
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_app_services__["b" /* UserService */],
            __WEBPACK_IMPORTED_MODULE_2_angular2_toaster__["c" /* ToasterService */],
            __WEBPACK_IMPORTED_MODULE_6__angular_platform_browser__["c" /* DomSanitizer */], __WEBPACK_IMPORTED_MODULE_7_ng4_loading_spinner__["Ng4LoadingSpinnerService"],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_ng2_file_upload__ = __webpack_require__("../../../../ng2-file-upload/fesm5/ng2-file-upload.js");
    ...
    ProfileModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_7_angular2_toaster__["b" /* ToasterModule */],
                __WEBPACK_IMPORTED_MODULE_5_ngx_bootstrap__["a" /* BsDatepickerModule */].forRoot(),
                __WEBPACK_IMPORTED_MODULE_8_ng2_file_upload__["a" /* FileUploadModule */],
                __WEBPACK_IMPORTED_MODULE_9_ng4_loading_spinner__["Ng4LoadingSpinnerModule"]
            ],
...
/***/ "../../../../ng2-file-upload/fesm5/ng2-file-upload.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* unused harmony export FileDropDirective */
/* unused harmony export FileItem */
/* unused harmony export FileLikeObject */
/* unused harmony export FileSelectDirective */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FileUploadModule; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return FileUploader; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common__ = __webpack_require__("../../../common/esm5/common.js");
...
var FileSelectDirective = /** @class */ (function () {
    ...
    FileSelectDirective.decorators = [
        { type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["Directive"], args: [{ selector: '[ng2FileSelect]' },] }
    ];
    /** @nocollapse */
    ...
    FileSelectDirective.propDecorators = {
        uploader: [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"] }],
        onFileSelected: [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"] }],
        onChange: [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["HostListener"], args: ['change',] }]
    };
...
var FileDropDirective = /** @class */ (function () {
    function FileDropDirective(element) {
        this.fileOver = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
    ...
    FileDropDirective.decorators = [
        { type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["Directive"], args: [{ selector: '[ng2FileDrop]' },] }
    ];
    /** @nocollapse */
    ...
    FileDropDirective.propDecorators = {
        uploader: [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"] }],
        fileOver: [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"] }],
